    ...
    <div className="bg-white space-y-10 px-4 py-4 lg:px-16 md:h-screen items-center justify-center">
      <Collapse in={isSuccess}>
        ...
        >
          ...
          means the world to us, and we're truly grateful for your trust in our
          vision. We'll keep you updated with exclusive sneak peeks and exciting
          news. Your feedback is important to us, and we can't wait to hear your
          thoughts once you explore our platform.
        </Alert>
      </Collapse>
      ...
      <form className="flex flex-col items-center justify-center gap-y-10">
        ...
        <TextField
          ...
          helperText={errorText === 'Email is required' && 'Email is required'}
          fullWidth
        />
        <LoadingButton
          loading={loading}
